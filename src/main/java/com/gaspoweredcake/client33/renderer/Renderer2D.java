...
public class Renderer2D {
    ...
    public Renderer2D(boolean textured) {
        ...
        triangles = new MeshBuilder(textured ? Client33RenderPipelines.UI_TEXTURED : Client33RenderPipelines.UI_COLORED);
        lines = new MeshBuilder(Client33RenderPipelines.UI_COLORED_LINES);
    }
