...
public class ServerCommand extends Command {
    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof ClientboundCommandsPacket packet) {
            ...
            packet.getRoot(
                CommandBuildContext.simple(handler.client33$getRegistryAccess(), handler.client33$getEnabledFeatures()),
                ClientPacketListenerAccessor.client33$getCommandNodeFactory()
