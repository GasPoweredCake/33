    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof CommandTreeS2CPacket packet) {
            ...
            packet.getCommandTree(
                CommandRegistryAccess.of(handler.client33$getCombinedDynamicRegistries(), handler.client33$getEnabledFeatures()),
                ClientPlayNetworkHandlerAccessor.client33$getCommandNodeFactory()
