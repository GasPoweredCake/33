...
import com.gaspoweredcake.client33.systems.modules.misc.swarm.SwarmConnection;
import com.gaspoweredcake.client33.systems.modules.misc.swarm.SwarmWorker;
import com.gaspoweredcake.client33.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new Client33ClickEvent(".swarm join confirm"))
                                    ));
