...
import com.gaspoweredcake.client33.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapInstance texture = textureManager.client33$invokeGetOrCreateMapInstance(map.get(DataComponents.MAP_ID), state);
