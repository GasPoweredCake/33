...
import com.gaspoweredcake.client33.mixin.ItemRenderStateAccessor;
...
public class ItemPhysics extends Module {
    ...
    private void onRenderItemEntity(RenderItemEntityEvent event) {
        ...
        for (int i = 0; i < ((ItemRenderStateAccessor) event.renderState.itemRenderState).client33$getLayerCount(); i++) {
            ItemRenderState.LayerRenderState layer = ((ItemRenderStateAccessor) event.renderState.itemRenderState).client33$getLayers()[i];
