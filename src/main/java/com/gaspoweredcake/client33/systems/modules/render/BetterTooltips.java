...
import com.gaspoweredcake.client33.gui.screens.ContainerInventoryScreen;
import com.gaspoweredcake.client33.mixin.EntityAccessor;
import com.gaspoweredcake.client33.mixin.EntityBucketItemAccessor;
...
import com.gaspoweredcake.client33.utils.misc.ByteCountDataOutput;
...
import com.gaspoweredcake.client33.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    public static final Color ECHEST_COLOR = new Color(32, 28, 48);
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((EntityBucketItemAccessor) bucketItem).client33$getEntityType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).client33$setInWater(true);
