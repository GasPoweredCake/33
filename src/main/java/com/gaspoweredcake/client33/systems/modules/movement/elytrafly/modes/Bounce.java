...
package com.gaspoweredcake.client33.systems.modules.movement.elytrafly.modes;

import com.gaspoweredcake.client33.Client33;
import com.gaspoweredcake.client33.events.packets.PacketEvent;
import com.gaspoweredcake.client33.systems.modules.movement.elytrafly.ElytraFlightMode;
    ...
    private static boolean startGliding(LocalPlayer player) {
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            if (LivingEntity.canGlideUsing(player.getItemBySlot(equipmentSlot), equipmentSlot)) {
                Client33.mc.executeIfPossible(player::startFallFlying);
                return true;
            }
        }
