    ...
    private void onMove(PlayerMoveEvent event) {
        ...
        if (avoidLanding.get()) {
            ...
            for (Direction dir : DirectionAccessor.client33$getHorizontal()) {
                ...
                if (((BlockBehaviourAccessor) mc.level.getBlockState(pos).getBlock()).client33$isHasCollision() && Math.abs(targetPos.y() - (pos.getY() + 1)) <= 0.25) {
        ...
        ((IVec3) event.movement).client33$set(xVel, yVel, zVel);
    }
