...
import com.gaspoweredcake.client33.mixin.ClientConnectionAccessor;
...
public class OffhandCrash extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        Channel channel = ((ClientConnectionAccessor) mc.player.networkHandler.getConnection()).client33$getChannel();
