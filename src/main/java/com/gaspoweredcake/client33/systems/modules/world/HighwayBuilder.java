...
import com.gaspoweredcake.client33.mixin.MinecraftMixin;
import com.gaspoweredcake.client33.mixin.ShulkerBoxMenuAccessor;
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.level.entitiesForRendering()) {
                    ...
                    ((IVec3) vec1).client33$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getEyeHeight(), b.mc.player.getZ());
                    ((IVec3) vec2).client33$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock _ -> {
                        if (b.mc.gui.screen() instanceof ShulkerBoxScreen screen) {
                            ...
                            Container inv = ((ShulkerBoxMenuAccessor) screen.getMenu()).client33$getContainer();
