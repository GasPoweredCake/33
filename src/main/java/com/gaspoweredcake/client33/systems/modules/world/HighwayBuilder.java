...
import com.gaspoweredcake.client33.mixin.ShulkerBoxScreenHandlerAccessor;
...
import com.gaspoweredcake.client33.systems.modules.combat.KillAura;
...
import com.gaspoweredcake.client33.utils.misc.HorizontalDirection;
import com.gaspoweredcake.client33.utils.misc.MBlockPos;
import com.gaspoweredcake.client33.utils.player.*;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.world.getEntities()) {
                    ...
                    ((IVec3d) vec1).client33$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getStandingEyeHeight(), b.mc.player.getZ());
                    ((IVec3d) vec2).client33$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock ignored -> {
                        if (b.mc.currentScreen instanceof ShulkerBoxScreen screen) {
                            ...
                            Inventory inv = ((ShulkerBoxScreenHandlerAccessor) screen.getScreenHandler()).client33$getInventory();
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see com.gaspoweredcake.client33.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
