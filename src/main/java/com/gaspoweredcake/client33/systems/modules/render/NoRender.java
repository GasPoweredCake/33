...
import com.gaspoweredcake.client33.events.render.RenderBlockEntityEvent;
import com.gaspoweredcake.client33.events.world.ChunkOcclusionEvent;
import com.gaspoweredcake.client33.events.world.ParticleEvent;
import com.gaspoweredcake.client33.mixin.BlockEntityRenderStateAccessor;
...
public class NoRender extends Module {
    ...
    private void onRenderBlockEntity(RenderBlockEntityEvent event) {
        if (blockEntities.get().contains(((BlockEntityRenderStateAccessor) event.blockEntityState).client33$getBlockState().getBlock())) event.cancel();
    }
