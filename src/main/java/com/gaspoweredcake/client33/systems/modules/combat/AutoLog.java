...
import com.gaspoweredcake.client33.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        Client33.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        Client33.EVENT_BUS.unsubscribe(staticListener);
    }
}
