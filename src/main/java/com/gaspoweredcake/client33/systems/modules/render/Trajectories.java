...
import com.gaspoweredcake.client33.utils.entity.simulator.ProjectileEntitySimulator;
import com.gaspoweredcake.client33.utils.entity.simulator.SimulationStep;
...
public class Trajectories extends Module {
    ...
    private final Setting<SettingColor> sideColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(255, 195, 110, 35))
        .build()
    );
