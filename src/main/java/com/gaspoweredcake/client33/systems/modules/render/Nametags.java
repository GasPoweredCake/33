...
import com.gaspoweredcake.client33.systems.modules.player.NameProtect;
...
public class Nametags extends Module {
    ...
    private final Setting<SettingColor> background = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(20, 18, 32, 175))
        .build()
    );
    ...
    private final Setting<SettingColor> pingColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(100, 215, 230))
    ...
    private final Setting<SettingColor> distanceColor = sgRender.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(188, 179, 205))
        .visible(() -> displayDistance.get() && distanceColorMode.get() == DistanceColorMode.Flat)
        .build()
    );

    private final Color WHITE = new Color(242, 238, 255);
    private final Color RED = new Color(255, 112, 135);
    private final Color AMBER = new Color(255, 195, 110);
    private final Color GREEN = new Color(103, 224, 181);
    private final Color GOLD = new Color(255, 195, 110);
