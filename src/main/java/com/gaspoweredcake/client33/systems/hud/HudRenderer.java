...
import com.gaspoweredcake.client33.renderer.*;
import com.gaspoweredcake.client33.renderer.text.CustomTextRenderer;
import com.gaspoweredcake.client33.renderer.text.Font;
import com.gaspoweredcake.client33.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(Client33RenderPipelines.UI_TEXT);
