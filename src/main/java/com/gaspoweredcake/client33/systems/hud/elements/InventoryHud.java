...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = Client33.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = Client33.identifier("textures/container-transparent.png");
