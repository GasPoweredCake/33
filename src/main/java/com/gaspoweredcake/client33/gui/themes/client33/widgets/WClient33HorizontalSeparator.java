...
import com.gaspoweredcake.client33.gui.widgets.WHorizontalSeparator;

public class WClient33HorizontalSeparator extends WHorizontalSeparator implements Client33Widget {
    public WClient33HorizontalSeparator(String text) {
        super(text);
    }
