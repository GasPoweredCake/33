...
public class WClient33TextBox extends WTextBox implements Client33Widget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WClient33TextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WClient33Label implements ICompletionItem {
