...
package com.gaspoweredcake.client33.asm.transformers;

import com.gaspoweredcake.client33.asm.AsmTransformer;
import com.gaspoweredcake.client33.asm.Descriptor;
import com.gaspoweredcake.client33.asm.MethodInfo;
...
public class PacketInflaterTransformer extends AsmTransformer {
    ...
    public void transform(ClassNode klass) {
        ...
        if (method == null) error("[33] Could not find method PacketInflater.decode()");
        ...
        for (AbstractInsnNode insn : method.instructions) {
            if (insn instanceof TypeInsnNode typeInsn && typeInsn.getOpcode() == Opcodes.NEW && typeInsn.desc.equals("io/netty/handler/codec/DecoderException")) {
                ...
                if (newCount == 2) {
                    ...
                    list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/gaspoweredcake/client33/systems/modules/Modules", "get", "()Lcom/gaspoweredcake/client33/systems/modules/Modules;", false));
                    list.add(new LdcInsnNode(Type.getType(AntiPacketKick.class)));
                    list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "com/gaspoweredcake/client33/systems/modules/Modules", "isActive", "(Ljava/lang/Class;)Z", false));
        ...
        error("[33] Failed to modify PacketInflater.decode()");
    }
}
