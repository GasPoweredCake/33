...
import com.gaspoweredcake.client33.mixin.AbstractMountInventoryMenuAccessor;
import com.gaspoweredcake.client33.mixin.CreativeModeInventoryScreenAccessor;
import com.gaspoweredcake.client33.mixin.CreativeModeTabsAccessor;
...
public class SlotUtils {
    ...
    private static int creativeInventory(int i) {
        if (CreativeModeInventoryScreenAccessor.client33$getSelectedTab() != BuiltInRegistries.CREATIVE_MODE_TAB.getValue(CreativeModeTabsAccessor.client33$getInventory()))
            return -1;
    ...
    private static int horse(AbstractContainerMenu handler, int i) {
        LivingEntity entity = ((AbstractMountInventoryMenuAccessor) handler).client33$getMount();
