...
public class ChatUtils {
    ...
    public static void init() {
        PREFIX = Text.empty()
            ...
            .append("[")
            .append(Text.literal(Client33.NAME).setStyle(Style.EMPTY.withColor(TextColor.fromRgb(Client33.ADDON.color.getPacked()))))
            .append("] ");
    }

    public static Text getClient33Prefix() {
        return PREFIX;
    }
    ...
    public static void sendMsg(int id, @Nullable String prefixTitle, @Nullable Formatting prefixColor, Text msg) {
        ...
        mc.execute(() -> ((IChatHud) mc.inGameHud.getChatHud()).client33$add(message, finalId));
    }
