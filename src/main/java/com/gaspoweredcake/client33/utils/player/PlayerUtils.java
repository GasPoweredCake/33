...
import com.gaspoweredcake.client33.systems.modules.movement.NoFall;
...
import com.gaspoweredcake.client33.utils.misc.text.TextUtils;
...
import static com.gaspoweredcake.client33.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).client33$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).client33$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).client33$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).client33$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
