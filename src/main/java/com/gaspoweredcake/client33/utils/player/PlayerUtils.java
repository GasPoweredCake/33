...
public class PlayerUtils {
    ...
    public static Vec3 getHorizontalVelocity(double bps) {
        ...
        ((IVec3) horizontalVelocity).client33$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3) vec1).client33$set(mc.player.getX(), mc.player.getY() + mc.player.getEyeHeight(), mc.player.getZ());
        ((IVec3) vec2).client33$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3) vec2).client33$set(entity.getX(), entity.getY() + entity.getEyeHeight(), entity.getZ());
