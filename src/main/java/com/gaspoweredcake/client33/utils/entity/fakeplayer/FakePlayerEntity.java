...
import com.gaspoweredcake.client33.mixin.AbstractClientPlayerEntityAccessor;
...
public class FakePlayerEntity extends OtherClientPlayerEntity {
    ...
    protected PlayerListEntry getPlayerListEntry() {
        ...
        if (entry == null) {
            ((AbstractClientPlayerEntityAccessor) this).client33$setPlayerListEntry(mc.getNetworkHandler().getPlayerListEntry(mc.player.getUuid()));
        }
