...
package com.gaspoweredcake.client33.utils.entity.fakeplayer;

import com.mojang.authlib.GameProfile;
import com.gaspoweredcake.client33.mixin.AbstractClientPlayerAccessor;
...
public class FakePlayerEntity extends RemotePlayer {
    ...
    @Override
    public int getId() {
        return ((EntityAccessor) this).client33$getId();
    }
    ...
    protected PlayerInfo getPlayerInfo() {
        ...
        if (entry == null) {
            ((AbstractClientPlayerAccessor) this).client33$setPlayerInfo(mc.getConnection().getPlayerInfo(mc.player.getUUID()));
        }
