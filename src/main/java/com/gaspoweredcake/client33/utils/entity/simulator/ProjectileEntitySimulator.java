...
package com.gaspoweredcake.client33.utils.entity.simulator;

import com.gaspoweredcake.client33.mixin.CrossbowItemAccessor;
import com.gaspoweredcake.client33.mixin.ProjectileInGroundAccessor;
...
public class ProjectileEntitySimulator {
    ...
    public boolean set(Entity user, ItemStack itemStack, double angleOffset, boolean accurate, float tickDelta) {
        ...
        switch (item) {
            ...
            case CrossbowItem _ -> {
                ...
                float speed = CrossbowItemAccessor.client33$getSpeed(projectilesComponent);
    ...
    public boolean set(Entity entity) {
        ...
        if (entity instanceof ProjectileInGroundAccessor ppe && ppe.client33$invokeIsInGround()) return false;
    ...
    public SimulationStep tick() {
        tickCount++;
        ((IVec3) prevPos3d).client33$set(pos);
    ...
    private SimulationStep getCollision() {
        ...
        if (blockCollision.getType() != HitResult.Type.MISS) {
            ((IVec3) pos3d).client33$set(blockCollision.getLocation());
        }
