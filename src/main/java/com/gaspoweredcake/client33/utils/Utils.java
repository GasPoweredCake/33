...
package com.gaspoweredcake.client33.utils;
...
import com.gaspoweredcake.client33.mixin.*;
import com.gaspoweredcake.client33.mixininterface.IMinecraftClient;
import com.gaspoweredcake.client33.settings.StatusEffectAmplifierMapSetting;
import com.gaspoweredcake.client33.systems.modules.Modules;
import com.gaspoweredcake.client33.systems.modules.render.BetterTooltips;
import com.gaspoweredcake.client33.systems.modules.world.Timer;
import com.gaspoweredcake.client33.utils.misc.Names;
import com.gaspoweredcake.client33.utils.player.EChestMemory;
import com.gaspoweredcake.client33.utils.render.PeekScreen;
import com.gaspoweredcake.client33.utils.render.RenderUtils;
import com.gaspoweredcake.client33.utils.render.color.Color;
import com.gaspoweredcake.client33.utils.world.BlockEntityIterator;
import com.gaspoweredcake.client33.utils.world.ChunkIterator;
...
public class Utils {
    ...
    private static final ProjectionMatrix2 matrix = new ProjectionMatrix2("client33-projection-matrix", -10, 100, true);
    ...
    public static void init() {
        Client33.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static int getRenderDistance() {
        return Math.max(mc.options.getViewDistance().getValue(), ((ClientPlayNetworkHandlerAccessor) mc.getNetworkHandler()).client33$getChunkLoadDistance());
    }
    ...
    public static void unscaledProjection() {
        ...
        RenderUtils.projection.set(((ProjectionMatrix2Accessor) matrix).client33$callGetMatrix(width, height));
    ...
    public static void getItemsInContainerItem(ItemStack itemStack, ItemStack[] items) {
        ...
        if (components.contains(DataComponentTypes.CONTAINER)) {
            ...
            DefaultedList<ItemStack> stacks = container.client33$getStacks();
    ...
    public static boolean hasItems(ItemStack itemStack) {
        ...
        if (container != null && !container.client33$getStacks().isEmpty()) return true;
    ...
    public static String getWorldName() {
        ...
        if (mc.isInSingleplayer()) {
            ...
            File folder = ((MinecraftServerAccessor) mc.getServer()).client33$getSession().getWorldDirectory(mc.world.getRegistryKey()).toFile();
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            Client33.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
    ...
    public static void leftClick() {
        ...
        int attackCooldown = ((MinecraftClientAccessor) mc).client33$getAttackCooldown();
        if (attackCooldown == 10000) {
            ((MinecraftClientAccessor) mc).client33$setAttackCooldown(0);
        }

        mc.options.attackKey.setPressed(true);
        ((MinecraftClientAccessor) mc).client33$leftClick();
        mc.options.attackKey.setPressed(false);
    }

    public static void rightClick() {
        ((IMinecraftClient) mc).client33$rightClick();
    }
    ...
    public static boolean isLoading() {
        ResourceReloadLogger.ReloadState state = ((ResourceReloadLoggerAccessor) ((MinecraftClientAccessor) mc).client33$getResourceReloadLogger()).client33$getReloadState();
        return state == null || !((ReloadStateAccessor) state).client33$isFinished();
    }
